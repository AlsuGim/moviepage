...
from .models import Category, Genre, Movie, MovieShots, Actor, Rating, RatingStar, Reviews, Paket
...
class MovieAdmin(TranslationAdmin):
    ...
    fieldsets = (
        ...
        ("Actors", {
            "classes": ("collapse",),
            "fields": (("actors", "directors", "geners", "category"),)
        }),
        (None, {
            "fields": (("budget", "fess_in_usa", "fess_in_world"),)
        }),
        ("Options", {
            "fields": (("url", "draft", "file"),)
        }),
    )
...
class PaketAdmin(admin.ModelAdmin):
    """Пакеты"""
    list_display = ("name", "price", "months","pic")
